...
class _ChatApiService implements ChatApiService {
  ...
  @override
  Future<HttpResponse<GetChatResponse>> getChat() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<GetChatResponse>>(
    ...
    late GetChatResponse _value;
    try {
      _value = GetChatResponse.fromMap(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<HttpResponse<SendMessageResponse>> sendMessage({
    ...
    try {
      _value = SendMessageResponse.fromMap(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
