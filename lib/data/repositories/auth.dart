...
class AuthRepositoryImpl extends BaseApiRepository implements AuthRepository {
  ...
  @override
  Future<DataState<LoginResponse>> login({required String email, required String password}) {
  ...
  @override
  Future<DataState<LoginResponse>> signUp({required String name, required String email, required String password}) {
    return getStateOf<LoginResponse>(
  ...
  Future<DataState<MessageResponse>> checkEmail({required String email}) {
    return getStateOf<MessageResponse>(
      request: () => _authApiService.checkEmail(
        body: {
          "email": email,
        },
      ),
